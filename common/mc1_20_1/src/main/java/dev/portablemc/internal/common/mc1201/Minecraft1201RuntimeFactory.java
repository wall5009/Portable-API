...
/** Runtime factory for Minecraft 1.20.1 targets. */
public final class Minecraft1201RuntimeFactory {
  private Minecraft1201RuntimeFactory() {}

  /** Creates the shared runtime for a 1.20.1 loader target. */
  public static CorePortableRuntime create(PlatformInfo platform) {
    Objects.requireNonNull(platform, "platform");
    return new CorePortableRuntime(platform, capabilities(), new Minecraft1201TargetBridge());
  }

  /** Returns the 1.20.1 v1 capability profile. */
  public static CapabilityReport capabilities() {
    return DefaultCapabilityReport.builder()
        ...
        .deferred(
            ...
            "Persistent attachment/component storage differs too much for v1.")
