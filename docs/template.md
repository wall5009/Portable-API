...
The template demonstrates one simple block, one simple item, vanilla creative-tab placement, a small command tree, typed config, one portable client-to-server packet, one portable server-to-client reply, lifecycle registration, and structured generated resources.
