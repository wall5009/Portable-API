...
/** Fabric 1.20.1 bootstrap. */
public final class PortableFabric1201 implements ModInitializer {
  @Override
  public void onInitialize() {
    CorePortableRuntime runtime = Minecraft1201RuntimeFactory.create(platformInfo());
